...
export const csvImportRowSchema = z.object({
  ...
  bhk: bhkEnum.optional(),
  purpose: purposeEnum,
  budgetMin: z.string().transform((val) => val ? parseInt(val) : undefined).pipe(z.number().int().positive().optional()),
  budgetMax: z.string().transform((val) => val ? parseInt(val) : undefined).pipe(z.number().int().positive().optional()),
  timeline: timelineEnum,
  source: sourceEnum,
